        ...
        Column(
            ...
            Card(
                ...
                Column(modifier = Modifier.padding(20.dp)) {
                    DetailRow(
                        label = "Nama Barang",
                        value = viewModel.detailUiState.nama,
                    ...
                    DetailRow(
                        label = "Kategori",
                        value = viewModel.detailUiState.kategori,
                    ...
                    DetailRow(
                        label = "Jumlah Total",
                        value = viewModel.detailUiState.jumlah_total.toString(),
...
fun DetailRow(
    ...
    Row(verticalAlignment = Alignment.CenterVertically) {
        Icon(
            imageVector = icon,
            contentDescription = null,
            tint = colorResource(id = R.color.navy_gray),
